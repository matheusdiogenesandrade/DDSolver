...
# Example explained in "Decision Diagrams for Optimization" (David Bergman, Andre A. Cire, Willem-Jan van Hoeve, and John Hooker), page 59

function indepedent_set_test(V, E)
  # parameters
  empty_domain = -1                            # any value is valid, since the domain 0 always will be available (check get_candidates function definition), this happens because the problem model guarantees this.
